...
public class UIPatientMenu {
    ...
    private static void showBookAppointmentMenu(){
        ...
        do {
            ...
            int k=0;
            for (int i = 0; i < UIDoctorMenu.doctorsAvailableApointments.size(); i++) {
                ArrayList<Doctor.AvailableAppointment> availableAppointments = UIDoctorMenu.doctorsAvailableApointments.get(i).getAvailableAppointments();

                for (int j = 0; j < availableAppointments.size(); j++) {
                    Map<Integer, Doctor> doctorAppointments = new TreeMap<>();
                    k++;
                    System.out.println(k + ". "+availableAppointments.get(j).getDate());
                    doctorAppointments.put(Integer.valueOf(j), UIDoctorMenu.doctorsAvailableApointments.get(i));
